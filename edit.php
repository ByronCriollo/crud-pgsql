...
<body>
    ...
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Editar usuario:  <?php echo $user->username ?></h2>
            <form action="<?php echo User::baseurl() ?>update.php" method="POST">
                ...
                <input type="submit" name="submit" class="btn btn-default" value="Actualizar" />
            </form>
        </div>
    </div>
</body>
